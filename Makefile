# This Makefile is for the PDL::McIDAS extension to perl.
#
...
#	DEFINE => undef
#	INC => q[-I/usr/lib/perl5/PDL/Core]
#	LIBS => q[-L/usr/lib/gcc-lib/i386-linux/2.95.4 -L/usr/lib -lg2c -lm -L/usr/lib/gcc-lib/i386-linux/2.95.4 -lgcc -lg2c]
#	NAME => q[PDL::McIDAS]
#	OBJECT => q[McIDAS.o grdlist.o grd2pdl.o]
#	PM => { McIDAS.pm=>q[$(INST_LIBDIR)/McIDAS.pm] }
#	TYPEMAPS => [q[/usr/lib/perl5/PDL/Core/typemap.pdl]]
#	VERSION_FROM => q[McIDAS.pp]
#	clean => { FILES=>q[McIDAS.c McIDAS.pm McIDAS.xs McIDAS.o grdlist.o grd2pdl.o] }
...
INC = -I/usr/lib/perl5/PDL/Core
OBJECT = McIDAS$(OBJ_EXT) grdlist$(OBJ_EXT) grd2pdl$(OBJ_EXT)
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
TO_INST_PM = McIDAS.pm

PM_TO_BLIB = McIDAS.pm \
	$(INST_LIBDIR)/McIDAS.pm
...
XSPROTOARG = 
XSUBPPDEPS = $(XSUBPPDIR)/typemap /usr/lib/perl5/PDL/Core/typemap.pdl $(XSUBPP)
XSUBPPARGS = -typemap $(XSUBPPDIR)/typemap -typemap /usr/lib/perl5/PDL/Core/typemap.pdl
...
# PDL::McIDAS might depend on some other libraries:
# See ExtUtils::Liblist for details
#
EXTRALIBS = -L/usr/lib/gcc-lib/i386-linux/2.95.4 -L/usr/lib -lg2c -lm -L/usr/lib/gcc-lib/i386-linux/2.95.4 -lgcc -lg2c
LDLOADLIBS = -L/usr/lib/gcc-lib/i386-linux/2.95.4 -L/usr/lib -lg2c -lm -L/usr/lib/gcc-lib/i386-linux/2.95.4 -lgcc -lg2c
BSLOADLIBS = 
LD_RUN_PATH = /usr/lib/gcc-lib/i386-linux/2.95.4
...
manifypods : pure_all McIDAS.pm
	@$(POD2MAN) \
	McIDAS.pm \
	$(INST_MAN3DIR)/PDL::McIDAS.$(MAN3EXT)
...
clean ::
	-rm -rf McIDAS.c McIDAS.c McIDAS.pm McIDAS.xs McIDAS.o grdlist.o grd2pdl.o ./blib $(MAKE_APERL_FILE) $(INST_ARCHAUTODIR)/extralibs.all perlmain.c mon.out core core.*perl.*.? *perl.core so_locations pm_to_blib *$(OBJ_EXT) *$(LIB_EXT) perl.exe $(BOOTSTRAP) $(BASEEXT).bso $(BASEEXT).def $(BASEEXT).exp
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"PDL-McIDAS\" VERSION=\"0,1,0,0\">\n}. qq{\t<TITLE>PDL-McIDAS</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > PDL-McIDAS.ppd
...
McIDAS.pm: McIDAS.pp
	$(PERL) -I/usr/lib/perl5 "-MPDL::PP qw/PDL::McIDAS PDL::McIDAS McIDAS/" McIDAS.pp
...
McIDAS$(OBJ_EXT): McIDAS.c
grdlist.o: grdlist.c
	cc -c -o grdlist.o -g grdlist.c

grd2pdl.o: grd2pdl.c
	cc -c -o grd2pdl.o -g grd2pdl.c
